...
public class HomePage extends Base {
	...
	public AndroidDriver clickCcrCbReport() {
		AndroidDriver driver = null;
		Boolean res = false;
		log = new Logging();
		try {
			...
			log.Logerror("HomePage.clickCcrCbReport()"+"\n"+e);
		}
		return driver;
	}
	
	public AndroidDriver clickCgt() {
		AndroidDriver driver = null;
		Boolean res = false;
		log = new Logging();
		try {
			...
			log.Logerror("HomePage.clickCgt()"+"\n"+e);
		}
		return driver;
	}
	
	public AndroidDriver clickGrt() {
		AndroidDriver driver = null;
		Boolean res = false;
		log = new Logging();
		try {
			...
			log.Logerror("HomePage.clickGrt()"+"\n"+e);
		}
		return driver;
	}
}
